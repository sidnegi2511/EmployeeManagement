/* 
  ...
  RATIONALE : 
    ...
    We want to be able to replace the 
      /config.js file in the assets ( or virtual assets folder ) as needed
...
// http://localhost:6103/dotClaimWebService
// apiBaseUrl: 'http://localhost:xxxx'